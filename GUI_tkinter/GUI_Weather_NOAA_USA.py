...
MSLPressure = tk.StringVar()
MSLPressureEntry = ttk.Entry(weather_conditions_frame, width=ENTRY_WIDTH, textvariable=MSLPressure, state='readonly')
MSLPressureEntry.grid(column=1, row=8, sticky='W')
#=============

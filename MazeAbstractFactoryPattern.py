...
class Door(MapSite):
    ...
    def OtherSideFrom(self,Room):
        print('\tDoor obj: This door is a side of Room: {}'.format(Room_roomNumber))
    ...
    def Enter(self):
        ...
        else: print('   ** This door needs to be opened before you pass through it...')
    ...
    def find_maze_rooms(maze_obj):  #Pass object into function
        ...
        for room_number in range(5):
            try:
                ...
                print('\next^^^ Maze has room: {}'.format(room_number.P))
                print(' Entering the room')

                #Append the rooms to list
